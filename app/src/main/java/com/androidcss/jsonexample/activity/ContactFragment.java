...
import com.androidcss.jsonexample.adapter.AdapterContact;
...
public class ContactFragment extends Fragment {
    ...
    private class AsyncLogin extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            pdLoading.dismiss();
            List<DataContact> data=new ArrayList<>();
            ...
            try {
                ...
                for(int i=0;i<jArray.length();i++){
                    ...
                    DataContact fishData = new DataContact();
                ...
                mAdapter = new AdapterContact(getActivity(), data);
